...
namespace bloodbank.Controllers {
    ...
    public class BloodBank_BloodGroupController : ControllerBase {
        ...
        // GET: api/BloodBank_BloodGroup/5
        [HttpGet("{id}")]
        ...
        // PUT: api/BloodBank_BloodGroup/5
        [HttpPut("{id}")]
        ...
        // DELETE: api/BloodBank_BloodGroup/5
        [HttpDelete("{id}")]
